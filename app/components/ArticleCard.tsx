...
export default function ArticleCard({
  ...
  if (variant === 'simple') {
    return (
      <div className={`group flex gap-3 py-3 border-b border-foreground/8 last:border-0 ${className}`}>
  ...
  if (variant === 'compact') {
    return (
      <div className={`group py-2.5 border-b border-foreground/8 last:border-0 ${className}`}>
        <div className="text-[10px] font-sans font-bold text-brand-red uppercase tracking-widest mb-1">
          {catLabel}
        </div>
        <Link href={href}>
