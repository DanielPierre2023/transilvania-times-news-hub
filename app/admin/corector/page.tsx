...
import {
  ...
  Upload, Globe, FileText, Loader2, X, RotateCcw
} from 'lucide-react'
      ...
      {tab === 'write' && (
        <div className="space-y-4">
          ...
          <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg p-4 space-y-3">
            ...
            <input ref={uploadRef} type="file" accept="image/*" onChange={handleImageUpload} className="hidden" id="corector-img-upload" />
            <label htmlFor="corector-img-upload"
      ...
      {tab === 'review' && proofResult?.ok && (
        <div className="space-y-4">
                  ...
                  <div key={i}
                    ...
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <div className="flex flex-col gap-1 shrink-0">
                        <button
                          onClick={() => { const u = [...corrections]; u[i] = { ...c, accepted: true }; setCorrections(u) }}
                        ...
                        <button
                          onClick={() => { const u = [...corrections]; u[i] = { ...c, accepted: false }; setCorrections(u) }}
          ...
          <button onClick={() => setTab('preview')} disabled={metaLoading}
            ...
            {metaLoading ? 'Se generează metadatele...' : 'Previzualizare & Publicare'}
          </button>
        </div>
      )}
