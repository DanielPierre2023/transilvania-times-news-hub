...
const FEATURES = [
  ...
  { name: 'Transcript editing',     lib: 'lib/podcast/edit.ts',          suite: '64-transcript-edit', page: 'podcast', control: 'onClick={cutSelection}' },
  { name: 'Undo / redo',            lib: 'lib/podcast/edit.ts',          suite: '64-transcript-edit', page: 'podcast', control: 'setHistory(undo)' },
  { name: 'Hear the edit',          lib: 'lib/podcast/edit.ts',          suite: '64-transcript-edit', page: 'podcast', control: 'el.currentTime = hit.to' },
  { name: 'Episode video',          lib: 'lib/podcast/episode.ts',       suite: '61-episode',      page: 'podcast',   control: 'Video 1080p' },
  { name: 'Episode MP3',            lib: 'render-worker/src/render.js',  suite: '63-audio-episode', page: 'podcast',  control: 'audioOnly: true' },
  { name: 'Loudness -16 LUFS',      lib: 'render-worker/src/audio.js',   suite: '63-audio-episode', page: 'podcast',  control: "useState<'podcast'" },
  { name: 'Music bed + ducking',    lib: 'render-worker/src/audio.js',   suite: '63-audio-episode', page: 'podcast',  control: 'setMusicUrl' },
  { name: 'Speaker balance',        lib: 'lib/timeline/migrate.ts',      suite: '64-transcript-edit', page: 'podcast', control: 'gainDbBySpeaker' },
  { name: 'Captions srt/vtt',       lib: 'lib/timeline/captions.ts',     suite: '22-captions-parity', page: 'podcast', control: 'toSRT(captionCues' },
  { name: 'Chapters, both formats', lib: 'lib/podcast/deliver.ts',       suite: '65-deliver',      page: 'podcast',   control: 'chaptersJson(chapterList' },
  { name: 'Title + description',    lib: 'lib/podcast/deliver.ts',       suite: '65-deliver',      page: 'podcast',   control: "'ai-blog-assistant'" },
